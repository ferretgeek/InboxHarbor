...
The built-in HTTP server applies a 10-second socket deadline and admits at most 64 worker threads. Verification-code context matching merges bounded windows and scans codes linearly.
