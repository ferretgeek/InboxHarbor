...
The service protects mailbox identities, Microsoft client IDs, refresh/access tokens, messages, verification codes, and remote access keys from application persistence, URLs, request logs, reflected upstream errors, screenshots, and fixtures.
...
It deliberately has no credential vault, password or app-password flow, custom IMAP/OAuth destinations, analytics, telemetry, remote fonts, or remote scripts.
